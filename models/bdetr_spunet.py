...
from .backbone_module_spunet import SpUNetBase
from .modules import (
...
class BeaUTyDETR_spunet(nn.Module):
    """
    ...
    def __init__(self, num_class=256, num_obj_class=485,
        ...
        # Visual encoder
        # spunet
        self.backbone_net = SpUNetBase(in_channels=input_feature_dim, out_channels=288)
