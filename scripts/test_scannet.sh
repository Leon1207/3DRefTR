TORCH_DISTRIBUTED_DEBUG=INFO CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch \
    ...
    --dataset scanrefer --test_dataset scannet \
    --detect_intermediate --joint_det \
    --use_soft_token_loss --use_contrastive_align \
    --log_dir log/ \
    --lr_decay_epochs 50 75 \
    --self_attend --augment_det \
    --checkpoint_path /userhome/backup_lhj/lhj/pointcloud/EDA-master/log/scanrefer/scanrefer_single_2gpu/1681781477/ckpt_epoch_74.pth \
    --model BeaUTyDETR \
    --eval \
