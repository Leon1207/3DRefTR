TORCH_DISTRIBUTED_DEBUG=INFO CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch \
    --nproc_per_node 2 --master_port 6666 \
    ...
    --log_dir log/spformer_731version_width_match0.0002_smalllr_paperckp_2gpu \
    ...
    --checkpoint_path /userhome/lyd/3dvlm/log/ScanRefer_54_59.pth \
    --max_epoch 120 \
