TORCH_DISTRIBUTED_DEBUG=INFO CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch \
    ...
    --log_dir log/spformer_731version_width_match0.0002_smalllr_box2mask \
    ...
    --checkpoint_path /userhome/lyd/3dvlm/log/spformer_731version_width_match_smalllr/scanrefer/EDA_spseg/1691142482/ckpt_epoch_92.pth \
    --max_epoch 100 \
