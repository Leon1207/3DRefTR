TORCH_DISTRIBUTED_DEBUG=INFO CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch \
    ...
    --log_dir log/spformer_731version_width_match_res2rec \
    ...
    --checkpoint_path /userhome/lyd/3dvlm/log/spformer_731version_onlyres/scanrefer/EDA_spseg/1691741346/ckpt_epoch_26.pth \
    --max_epoch 100 \
