TORCH_DISTRIBUTED_DEBUG=INFO CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch \
    ...
    --log_dir log/spformer_731version_width_frozen_test \
    ...
    --checkpoint_path //userhome/lyd/3dvlm/log/spformer_731version_frozen_width/scanrefer/EDA_spseg/1690871359/ckpt_epoch_96.pth \
    --max_epoch 100 \
